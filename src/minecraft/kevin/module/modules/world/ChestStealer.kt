...
class ChestStealer : Module("ChestStealer", description = "Automatically steals all items from a chest.", category = ModuleCategory.WORLD) {
    ...
    fun onRender3D(event: Render3DEvent?) {
        ...
        // inventory cleaner
        val inventoryCleaner = KevinClient.moduleManager.getModule("InventoryCleaner") as InventoryManager
    ...
    private inline fun shouldTake(stack: ItemStack?, inventoryCleaner: InventoryManager): Boolean {

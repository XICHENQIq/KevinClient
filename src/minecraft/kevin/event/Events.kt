...
class PacketProcessEvent(val packet: Packet<*>) : CancellableEvent()
 ...
 * Rise Client
 */
class MoveInputEvent(var forward: Float , var strafe: Float , var jump: Boolean , var sneak: Boolean , var sneakSlowDownMultiplier : Double) : Event()

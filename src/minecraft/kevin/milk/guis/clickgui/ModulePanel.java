...
import kevin.hud.font.UFontRenderer;
import kevin.milk.guis.clickgui.buttons.*;
import kevin.milk.guis.clickgui.buttons.Button;
...
public class ModulePanel {
    ...
    public void drawPanel(int x, int y, int mx, int my, float pticks, float anim, float scroll){
        UFontRenderer font = FontLoader.getCFont(false,18);
        int ia = (int)(255 * anim);
        ...
        FontLoader.getCFont(false,18).drawString("<", x + 52, y + 3, new Color(90, 90, 90, ia).getRGB());
        FontLoader.getCFont(false,22).drawString(module.getName(), x + 60, y + 13, new Color(255, 255, 255, ia).getRGB());

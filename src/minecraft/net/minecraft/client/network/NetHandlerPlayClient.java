...
import kevin.module.modules.exploit.KeepContainer;
import kevin.utils.BlinkUtils;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        if(this.gameController.world != null && this.gameController.player != null) {
            ChatUtils.INSTANCE.message(I18n.format("disconnect.lost") + ":");
            ChatUtils.INSTANCE.message(reason.getFormattedText());
            return;
        }

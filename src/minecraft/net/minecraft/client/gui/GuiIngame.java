...
public class GuiIngame extends Gui
{
    ...
    protected void renderHotbar(ScaledResolution sr, float partialTicks)
    {
        if (Minecraft.getMinecraft().getRenderViewEntity() instanceof EntityPlayer) {
            ...
            RenderUtils.drawRoundedRect(middleScreen - 91, sr.getScaledHeight() - 24, middleScreen + 90, sr.getScaledHeight(),4f, new Color(0,0,0,80).getRGB(),false);
            BlurBuffer.drawRoundRectBlur(middleScreen - 91, sr.getScaledHeight() - 24, middleScreen + 90, sr.getScaledHeight(),4f,1f);
            //GuiIngame.drawRect(middleScreen - 91, sr.getScaledHeight() - 24, middleScreen + 90, sr.getScaledHeight(), Integer.MIN_VALUE);

            RenderUtils.drawRoundedRect(middleScreen - 91 - 1 + entityPlayer.inventory.currentItem * 20 + 2, sr.getScaledHeight() - 24 + 1, middleScreen - 91 - 1 + entityPlayer.inventory.currentItem * 20 + 21, sr.getScaledHeight() - 22 - 1 + 23,3f,new Color(0,0,0,80).getRGB(),true);

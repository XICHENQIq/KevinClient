...
public class ModelBiped extends ModelBase
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        if (entityIn instanceof EntityPlayer) {
            if (entityIn.getEntityId() == Mc.getMc().player.getEntityId()) {
                if (((EntityPlayer) entityIn).getHeldItemMainhand().getItem() instanceof ItemSword && Mc.getMc().gameSettings.keyBindUseItem.isKeyDown()) {
                    this.rightArmPose = ModelBiped.ArmPose.BLOCK;
                }
            } else {
                if (((EntityPlayer) entityIn).getHeldItemMainhand().getItem() instanceof ItemSword && ((EntityPlayer) entityIn).isHandActive()) {
                    this.rightArmPose = ModelBiped.ArmPose.BLOCK;
                }
            }
        }

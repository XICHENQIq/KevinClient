...
import kevin.module.modules.combat.ObsAura;
...
public class CPacketPlayerTryUseItemOnBlock implements Packet<INetHandlerPlayServer>
{
    ...
    public void writePacketData(PacketBuffer buf) throws IOException
    {
        ...
        if (KevinClient.moduleManager.getModule(ObsAura.class).getState()) {
            buf.writeVarInt(6 + (this.placedBlockDirection.ordinal() * 7));
        } else {

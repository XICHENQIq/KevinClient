...
import kevin.module.modules.movement.FastLadder;
...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        FastLadder fastLadder = (FastLadder) KevinClient.moduleManager.getModule(FastLadder.class);
        if (fastLadder.getState() && fastLadder.getCancel()) {
            return false;
        }
    ...
    public void onLivingUpdate()
    {
        ...
        if (KevinClient.moduleManager.getModule(NoJumpDelay.class).getState()) {
            jumpTicks = 0;
        }
